...
/**
 ** \file /home/aschiffe/Dev/Fermi/Fermi/Syntax-Analysis/include/FermiParser.hpp
...
#ifndef YY_YY_HOME_ASCHIFFE_DEV_FERMI_FERMI_SYNTAX_ANALYSIS_INCLUDE_FERMIPARSER_HPP_INCLUDED
# define YY_YY_HOME_ASCHIFFE_DEV_FERMI_FERMI_SYNTAX_ANALYSIS_INCLUDE_FERMIPARSER_HPP_INCLUDED
// "%code requires" blocks.
#line 18 "/home/aschiffe/Dev/Fermi/Fermi/Syntax-Analysis/include/FermiParser.yy"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      char dummy5[sizeof (std::shared_ptr<StatementNode>)];
      ...
      // expression-list
      char dummy7[sizeof (std::vector<std::shared_ptr<ExpressionNode>>)];

      // statements
      char dummy8[sizeof (std::vector<std::shared_ptr<StatementNode>>)];
    };
    ...
    INT32_T = 23,                  // "int32_t"
    INT64_T = 24,                  // "int64_t"
    FLOAT32_T = 25,                // "float32_t"
    FLOAT64_T = 26                 // "float64_t"
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_ASSIGN = 13,                           // "="
        S_SEMI_COLON = 14,                       // ";"
        S_LEFT_PARENTHESIS = 15,                 // "("
        S_RIGHT_PARENTHESIS = 16,                // ")"
        S_COMMA = 17,                            // ","
        S_COLON = 18,                            // ":"
        S_LET = 19,                              // "let"
        S_PRINT = 20,                            // "print"
        S_INT8_T = 21,                           // "int8_t"
        S_INT16_T = 22,                          // "int16_t"
        S_INT32_T = 23,                          // "int32_t"
        S_INT64_T = 24,                          // "int64_t"
        S_FLOAT32_T = 25,                        // "float32_t"
        S_FLOAT64_T = 26,                        // "float64_t"
        S_YYACCEPT = 27,                         // $accept
        S_start = 28,                            // start
        S_statements = 29,                       // statements
        S_statement = 30,                        // statement
        S_31_expression_statement = 31,          // expression-statement
        S_32_variable_declaration = 32,          // variable-declaration
        S_type = 33,                             // type
        S_print_statement = 34,                  // print_statement
        S_35_expression_list = 35,               // expression-list
        S_36_assignment_statement = 36,          // assignment-statement
        S_expression = 37,                       // expression
        S_creation_expression = 38,              // creation_expression
        S_identity_expression = 39,              // identity_expression
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_31_expression_statement: // expression-statement
        value.move< std::shared_ptr<ExpressionStatementNode> > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<ExpressionStatementNode>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<ExpressionStatementNode>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    {
      ...
      case symbol_kind::S_31_expression_statement: // expression-statement
        value.template destroy< std::shared_ptr<ExpressionStatementNode> > ();
        break;
      ...
      {
        return FermiParser::symbol_name (this->kind ());
      }
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        ...
        YY_ASSERT (tok == token::YYEOF
                   ...
                   || (token::PLUS <= tok && tok <= token::FLOAT64_T));
#endif
      }
#if 201103L <= YY_CPLUSPLUS
...
#if 201103L <= YY_CPLUSPLUS
    /// Non copyable.
    FermiParser (const FermiParser&) = delete;
    /// Non copyable.
    FermiParser& operator= (const FermiParser&) = delete;
#endif
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_FLOAT_LITERAL (std::string v, location_type l)
      {
      ...
      static
      symbol_type
      make_FLOAT32_T (location_type l)
      {
        return symbol_type (token::FLOAT32_T, std::move (l));
      }
#else
      static
      symbol_type
      make_FLOAT32_T (const location_type& l)
      {
        return symbol_type (token::FLOAT32_T, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_FLOAT64_T (location_type l)
      {
        return symbol_type (token::FLOAT64_T, std::move (l));
      }
#else
      static
      symbol_type
      make_FLOAT64_T (const location_type& l)
      {
        return symbol_type (token::FLOAT64_T, l);
      }
#endif
    ...
    {
    public:
      context (const FermiParser& yyparser, const symbol_type& yyla);
...
#if YY_CPLUSPLUS < 201103L
    /// Non copyable.
    FermiParser (const FermiParser&);
    /// Non copyable.
    FermiParser& operator= (const FermiParser&);
#endif
    ...
    , location (that.location)
  {
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_31_expression_statement: // expression-statement
        value.copy< std::shared_ptr<ExpressionStatementNode> > (YY_MOVE (that.value));
        break;
  ...
  FermiParser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_31_expression_statement: // expression-statement
        value.move< std::shared_ptr<ExpressionStatementNode> > (YY_MOVE (s.value));
        break;
...
#endif // !YY_YY_HOME_ASCHIFFE_DEV_FERMI_FERMI_SYNTAX_ANALYSIS_INCLUDE_FERMIPARSER_HPP_INCLUDED
