...
/**
 ** \file /home/aschiffer/Fermi-Redux/src/syntax_analysis/parser.hpp
 ** Define the fermi::parser class.
 */
...
#ifndef YY_YY_HOME_ASCHIFFER_FERMI_REDUX_SRC_SYNTAX_ANALYSIS_PARSER_HPP_INCLUDED
# define YY_YY_HOME_ASCHIFFER_FERMI_REDUX_SRC_SYNTAX_ANALYSIS_PARSER_HPP_INCLUDED
// "%code requires" blocks.
#line 17 "/home/aschiffer/Fermi-Redux/src/syntax_analysis/parser.yy"
...
#line 59 "/home/aschiffer/Fermi-Redux/src/syntax_analysis/parser.hpp"
...
namespace fermi {
#line 200 "/home/aschiffer/Fermi-Redux/src/syntax_analysis/parser.hpp"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // expression-list-opt
      // expression-list
      char dummy3[sizeof (std::vector<std::size_t>)];

      // mode
      char dummy4[sizeof (syntax_nodes::function_parameter_attributes::attribute)];
    };
    ...
    TYPE_NAME = 9,                 // TYPE_NAME
    AS = 10,                       // "as"
    AMPERSAND = 11,                // "&"
    AND = 12,                      // "and"
    BOOL = 13,                     // "bool"
    COMPEVAL = 14,                 // "compeval"
    DEFINE = 15,                   // "define"
    ELSE = 16,                     // "else"
    ELSIF = 17,                    // "elsif"
    EXPORT = 18,                   // "export"
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_FLOAT = 4,                             // FLOAT
        S_COMPLEX = 5,                           // COMPLEX
        S_CHARACTER = 6,                         // CHARACTER
        S_STRING = 7,                            // STRING
        S_IDENTIFIER = 8,                        // IDENTIFIER
        S_TYPE_NAME = 9,                         // TYPE_NAME
        S_AS = 10,                               // "as"
        S_AMPERSAND = 11,                        // "&"
        S_AND = 12,                              // "and"
        S_BOOL = 13,                             // "bool"
        S_COMPEVAL = 14,                         // "compeval"
        S_DEFINE = 15,                           // "define"
        S_ELSE = 16,                             // "else"
        S_ELSIF = 17,                            // "elsif"
        S_EXPORT = 18,                           // "export"
        ...
        S_MODULE = 27,                           // "module"
        S_MOVE = 28,                             // "move"
        S_MUTABLE = 29,                          // "mutable"
        S_NEW = 30,                              // "new"
        S_NOT = 31,                              // "not"
        S_OPERATOR = 32,                         // "operator"
        S_OR = 33,                               // "or"
        S_OUT = 34,                              // "out"
        S_PUBLIC = 35,                           // "public"
        S_PURE = 36,                             // "pure"
        S_RANGE = 37,                            // "range"
        S_REQUIRES = 38,                         // "requires"
        S_RETURN = 39,                           // "return"
        S_STATIC = 40,                           // "static"
        S_STRUCT = 41,                           // "struct"
        S_THIS = 42,                             // "this"
        ...
        S_LEFT_BRACE = 52,                       // "{"
        S_LEFT_BRACKET = 53,                     // "["
        S_LEFT_PARENTHESIS = 54,                 // "("
        S_RIGHT_BRACE = 55,                      // "}"
        S_RIGHT_BRACKET = 56,                    // "]"
        S_RIGHT_PARENTHESIS = 57,                // ")"
        S_SEMICOLON = 58,                        // ";"
        S_ASSIGN = 59,                           // "="
        S_BANG = 60,                             // "!"
        S_BANG_EQUAL = 61,                       // "!="
        ...
        S_SLASH_EQUAL = 83,                      // "/="
        S_SLASH_SLASH = 84,                      // "//"
        S_SLASH_SLASH_EQUAL = 85,                // "//="
        S_SPACESHIP = 86,                        // "<=>"
        S_STAR = 87,                             // "*"
        S_STAR_EQUAL = 88,                       // "*="
        S_YYACCEPT = 89,                         // $accept
        S_start = 90,                            // start
        S_declarations = 91,                     // declarations
        S_declaration = 92,                      // declaration
        S_93_variable_declaration = 93,          // variable-declaration
        S_type = 94,                             // type
        S_95_simple_type = 95,                   // simple-type
        S_96_function_declaration = 96,          // function-declaration
        S_97_function_parameter_list_opt = 97,   // function-parameter-list-opt
        S_98_function_parameter_list = 98,       // function-parameter-list
        S_99_function_parameter = 99,            // function-parameter
        S_mode = 100,                            // mode
        S_101_return_type_opt = 101,             // return-type-opt
        S_102_return_type = 102,                 // return-type
        S_statements = 103,                      // statements
        S_statement = 104,                       // statement
        S_105_assignment_statement = 105,        // assignment-statement
        S_106_compound_statement = 106,          // compound-statement
        S_expression = 107,                      // expression
        S_108_primary_exression = 108,           // primary-exression
        S_literal = 109,                         // literal
        S_110_binary_expression = 110,           // binary-expression
        S_111_unary_expression = 111,            // unary-expression
        S_112_absolute_value_expression = 112,   // absolute-value-expression
        S_113_function_call_expression = 113,    // function-call-expression
        S_114_array_index_expression = 114,      // array-index-expression
        S_115_expression_list_opt = 115,         // expression-list-opt
        S_116_expression_list = 116              // expression-list
      };
    };
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_116_expression_list: // expression-list
        value.move< std::vector<std::size_t> > (std::move (that.value));
        break;

      case symbol_kind::S_mode: // mode
        value.move< syntax_nodes::function_parameter_attributes::attribute > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<std::size_t>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<std::size_t>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, syntax_nodes::function_parameter_attributes::attribute&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const syntax_nodes::function_parameter_attributes::attribute& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    {
      ...
      case symbol_kind::S_115_expression_list_opt: // expression-list-opt
      case symbol_kind::S_116_expression_list: // expression-list
        value.template destroy< std::vector<std::size_t> > ();
        break;

      case symbol_kind::S_mode: // mode
        value.template destroy< syntax_nodes::function_parameter_attributes::attribute > ();
        break;
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        ...
        YY_ASSERT (tok == token::YYEOF
                   ...
                   || (token::AS <= tok && tok <= token::STAR_EQUAL));
#endif
      }
#if 201103L <= YY_CPLUSPLUS
      ...
      {
#if !defined _MSC_VER || defined __clang__
        YY_ASSERT ((token::INTEGER <= tok && tok <= token::TYPE_NAME));
#endif
      }
    };

    /// Build a parser object.
    parser (fermi::lexer& lexer__yyarg, std::vector<syntax_nodes::syntax_node>& syntax_tree__yyarg);
    virtual ~parser ();
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_INTEGER (std::string_view v, location_type l)
      {
      ...
      static
      symbol_type
      make_INTEGER (const std::string_view& v, const location_type& l)
      {
      ...
      static
      symbol_type
      make_FLOAT (std::string_view v, location_type l)
      {
      ...
      static
      symbol_type
      make_FLOAT (const std::string_view& v, const location_type& l)
      {
      ...
      static
      symbol_type
      make_COMPLEX (std::string_view v, location_type l)
      {
        return symbol_type (token::COMPLEX, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_COMPLEX (const std::string_view& v, const location_type& l)
      {
        return symbol_type (token::COMPLEX, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_CHARACTER (std::string_view v, location_type l)
      {
        return symbol_type (token::CHARACTER, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_CHARACTER (const std::string_view& v, const location_type& l)
      {
        return symbol_type (token::CHARACTER, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_TYPE_NAME (std::string_view v, location_type l)
      {
      ...
      static
      symbol_type
      make_TYPE_NAME (const std::string_view& v, const location_type& l)
      {
      ...
      {
        return symbol_type (token::ELSIF, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::ELSIF, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_MUTABLE (location_type l)
      {
        return symbol_type (token::MUTABLE, std::move (l));
      }
#else
      static
      symbol_type
      make_MUTABLE (const location_type& l)
      {
        return symbol_type (token::MUTABLE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_BANG_EQUAL (location_type l)
      {
        return symbol_type (token::BANG_EQUAL, std::move (l));
      }
#else
      static
      symbol_type
      make_BANG_EQUAL (const location_type& l)
      {
        return symbol_type (token::BANG_EQUAL, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_MINUS_EQUAL (location_type l)
      {
        return symbol_type (token::MINUS_EQUAL, std::move (l));
      }
#else
      static
      symbol_type
      make_MINUS_EQUAL (const location_type& l)
      {
        return symbol_type (token::MINUS_EQUAL, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_SLASH_SLASH (location_type l)
      {
        return symbol_type (token::SLASH_SLASH, std::move (l));
      }
#else
      static
      symbol_type
      make_SLASH_SLASH (const location_type& l)
      {
        return symbol_type (token::SLASH_SLASH, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_SLASH_SLASH_EQUAL (location_type l)
      {
        return symbol_type (token::SLASH_SLASH_EQUAL, std::move (l));
      }
#else
      static
      symbol_type
      make_SLASH_SLASH_EQUAL (const location_type& l)
      {
        return symbol_type (token::SLASH_SLASH_EQUAL, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
  ...
  private:
    ...
    enum
    {
      yylast_ = 888,     ///< Last index in yytable_.
    ...
    , location (that.location)
  {
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_115_expression_list_opt: // expression-list-opt
      case symbol_kind::S_116_expression_list: // expression-list
        value.copy< std::vector<std::size_t> > (YY_MOVE (that.value));
        break;

      case symbol_kind::S_mode: // mode
        value.copy< syntax_nodes::function_parameter_attributes::attribute > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_115_expression_list_opt: // expression-list-opt
      case symbol_kind::S_116_expression_list: // expression-list
        value.move< std::vector<std::size_t> > (YY_MOVE (s.value));
        break;

      case symbol_kind::S_mode: // mode
        value.move< syntax_nodes::function_parameter_attributes::attribute > (YY_MOVE (s.value));
        break;
...
#line 3013 "/home/aschiffer/Fermi-Redux/src/syntax_analysis/parser.hpp"




#endif // !YY_YY_HOME_ASCHIFFER_FERMI_REDUX_SRC_SYNTAX_ANALYSIS_PARSER_HPP_INCLUDED
